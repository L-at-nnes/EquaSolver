...
const fr = {
    ...
    oneRealTwoComplex: "Une solution réelle et deux conjuguées complexes",
    realSolution: "réel",
    complexSolution: "complexe",
    complexRootsExplanation: "Quand Δ < 0, les racines sont complexes conjuguées :",
    ...
    // Inéquations
    inequalities: "Inéquations",
    inequalitiesDesc: "Résoudre linéaires et quadratiques",
    linearInequality: "Linéaire",
    quadraticInequality: "Quadratique",
    linearInequalityTitle: "Inéquation linéaire",
    quadraticInequalityTitle: "Inéquation quadratique",
    chooseType: "Choisir le type",
    inequality: "Inéquation",
    inequalityHint: "Choisissez le type d'inéquation et les coefficients",
    solutionSet: "Ensemble solution",
    intervalNotation: "Notation intervalle",
    divideNegative: "Division par un nombre négatif, l'inéquation change de sens",
    notQuadratic: "Le coefficient a ne peut pas être zéro pour une inéquation quadratique",
    noRealRoots: "pas de racines réelles",
    oneRoot: "une racine",
    twoRoots: "deux racines",
    findRoots: "Trouver les racines de",
    parabUpAlwaysPos: "Parabole vers le haut, toujours positive",
    parabDownAlwaysNeg: "Parabole vers le bas, toujours négative",
    parabolaTouches: "La parabole touche l'axe des x en",
